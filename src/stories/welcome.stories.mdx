...
**This project is in early stages of development. We are actively working hard to implement more components.**
...
The purpose of this package is to "Reactify" the Web Experience Toolkit (WET). This will make it faster and easier to develop applications using WET. It also removes the JQuery dependency of WET.
...
5. navigate to `http://localhost:6006` to see Storybook running based on your local code. As you save your changes, the storybook will automatically update.
